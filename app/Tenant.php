...
class Tenant extends Model
{
	...
	public static function provision(TenantSignup $signup, array $politicalAdminData, array $operationalAdminData)
	{
		...
		$politicalAdmin->save();
		$addUserAd->createUser($politicalAdmin->id, $politicalAdmin->name, $politicalAdmin->type,  $politicalAdmin->email);
		$addUserAd->createUser($operationalAdmin->id, $operationalAdmin->name, $operationalAdmin->type,  $operationalAdmin->email);
