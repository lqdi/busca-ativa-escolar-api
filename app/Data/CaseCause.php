...
class CaseCause extends StaticObject  {
	...
	protected static $data = [
        ...
        71 => ['id' => 71, 'alert_cause_id' => 70, 'slug' => 'evasao_desinteresse', 'label' => "Evasão porque sente a escola desinteressante "],
		72 => ['id' => 72, 'alert_cause_id' => 70, 'slug' => 'evasao_desinteresse_escola', 'label' => "Evasão porque sente a escola desinteressante (Desinteresse pela escola) "],
		73 => ['id' => 73, 'alert_cause_id' => 70, 'slug' => 'evasao_desinteresse_estudo', 'label' => "Evasão porque sente a escola desinteressante (Desinteresse pelos estudos) "],
		...
		101 => ['id' => 101, 'alert_cause_id' => 100, 'slug' => 'falta_transporte', 'label' => "Falta de transporte escolar "],
		102 => ['id' => 102, 'alert_cause_id' => 100, 'slug' => 'falta_transporte_escolar', 'label' => "Falta de transporte escolar (Transporte escolar público) "],
		103 => ['id' => 103, 'alert_cause_id' => 100, 'slug' => 'falta_transporte_publico', 'label' => "Falta de transporte escolar (Transporte público - ônibus, metrô, trem, balsa, barco etc.) "],
		104 => ['id' => 104, 'alert_cause_id' => 100, 'slug' => 'falta_transporte_particular', 'label' => "Falta de transporte escolar (Transporte particular - veículo próprio) "],
