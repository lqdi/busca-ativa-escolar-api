	...
	public static function getFormFields(): FormBuilder {
		return (new FormBuilder())
			...
			->group('place', trans('form_builder.pesquisa.group.place'), function (FormBuilder $group) {
				...
				->field('place_city_id', 'model', trans('form_builder.pesquisa.field.place_city_id'), ['key_as' => 'place_city', 'search_by' => 'name', 'source' => route('api.cities.search'), 'list_key' => 'results', 'key' => 'id', 'label' => 'name',  'is_available_offline' => true, 'offline_index' => 'cities_idx', 'offline_field' => 'search_string', 'offline_label' => 'display_string'])
