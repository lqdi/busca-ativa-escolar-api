	...
	public static function getFormFields(): FormBuilder {
		return (new FormBuilder())
			...
			->group('school', trans('form_builder.pesquisa.group.school'), function (FormBuilder $group) {
				...
				->field('school_last_id', 'model', trans('form_builder.pesquisa.field.school_last_id'), ['show_if_true' => 'has_been_in_school', 'key_as' => 'school_last', 'search_by' => 'name', 'source' => route('api.school.search'), 'key' => 'id', 'label' => 'name', 'list_key' => 'results', 'is_available_offline' => true, 'offline_index' => 'schools_idx', 'offline_field' => 'name'])
			...
			->group('place', trans('form_builder.pesquisa.group.place'), function (FormBuilder $group) {
				...
				->field('place_city_id', 'model', trans('form_builder.pesquisa.field.place_city_id'), ['key_as' => 'place_city', 'search_by' => 'name', 'source' => route('api.cities.search'), 'list_key' => 'results', 'key' => 'id', 'label' => 'name',  'is_available_offline' => true, 'offline_index' => 'cities_idx', 'offline_field' => 'name'])
