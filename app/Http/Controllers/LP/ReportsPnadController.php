    ...
    public function pnad_brasil()
    {
        ...
        try {
            ...
            $data = DB::connection('trajetorias')->table('pnad')->select(
                'id_localizacao',
                'id_faixa_etaria',
                DB::raw('SUM(value_masc) as value_masc'),
                DB::raw('SUM(value_femn) as value_femn'),
                DB::raw('SUM(value_ba) as value_ba'),
                DB::raw('SUM(value_pni) as value_pni'),
                DB::raw('SUM(value_sim) as value_sim'),
                DB::raw('SUM(value_nao) as value_nao'),
                DB::raw('SUM(value_pb) as value_pb'),
                DB::raw('SUM(value_int) as value_int'),
                DB::raw('SUM(value_rc) as value_rc'),
                DB::raw('SUM(total) as total'),
            )->where('id_municipio', '9999')->groupBy('id_faixa_etaria', 'id_localizacao')->get();
