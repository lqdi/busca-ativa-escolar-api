...
Aplicação Web-server-side baseada em PHP, com framework Laravel, banco de dados postgres e outros componetes. Provê estrutura de ao sistema Busca Ativa Escolar e aos aplicativos.
